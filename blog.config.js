...
const BLOG = {
  AUTHOR: 'Monkey船长', // 作者
  BIO: '做一个博学的老师。', // 作者简介
  LINK: 'https://ttalk.live', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'd9af45fa0aec47e78381da25cb2966e1', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  SINCE: 2022, 2022 // e.g if leave this empty, current year will be used.
  ...
  CONTACT_EMAIL: 'mr.sui.jt@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: 'https://twitter.com/monkey_sui',
  CONTACT_GITHUB: 'https://github.com/monkeysui',
  CONTACT_TELEGRAM: '',
  ...
  // COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'monkeysui/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  // COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOHzSDyQ', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  // COMMENT_GISCUS_CATEGORY_ID:
  //   process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHzSDyc4CQvfZ', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  // COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'monkeysui/NotionNext', // 你的Github仓库名，例如 'NotionNext'
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-PK3GQZV6RN', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
